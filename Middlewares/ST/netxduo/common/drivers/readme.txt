...
Main changes
-------------
- Fix NetXDuo STM32 Ethernet driver to correctly set packet data offset.
- Remove unused code related to obsolete flag NX_DRIVER_INTERNAL_TRANSMIT_QUEUE.
- Replace incorrect specific device defines with generic ones.
