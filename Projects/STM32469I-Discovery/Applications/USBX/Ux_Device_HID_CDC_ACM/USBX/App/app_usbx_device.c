...
UINT MX_USBX_Device_Init(VOID *memory_ptr)
{
  ...
  ret = tx_thread_create(&ux_cdc_read_thread, "cdc_acm_read_usbx_app_thread_entry",
  ...
  /* Create the usbx_cdc_acm_thread_entry thread.  */
  ret = tx_thread_create(&ux_cdc_write_thread, "cdc_acm_write_usbx_app_thread_entry",
  ...
  ret = tx_thread_create(&ux_hid_thread, "hid_usbx_app_thread_entry",
